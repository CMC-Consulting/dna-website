...
export default async function Page({ params }: { params: Params }) {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-20 md:pt-32 overflow-hidden border-b border-border/40 bg-gradient-to-b from-muted/50 to-background w-screen left-1/2 -translate-x-1/2">
        {/* Background Pattern */}
